...
The main 3D simulation files are volume_density_sweep.py, targeted_loading_long_single.py, and 3D_polysim_targeted_loading.py. These all run the 1D cohesin position simulation DSB_SMCTranslocator_v2.pyx, written by Hugo Brando for Yang et al., Nat Comms (2022).
