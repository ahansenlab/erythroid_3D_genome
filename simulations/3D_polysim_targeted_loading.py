...
save_base_folder = "/mnt/md1/varshini/Blood/sim_data_sweep_cohesins/"
chrom_size = 70000
region_size = 2000
...
simulation_sweep_space = {
    ...
    'loading_width': [8, 16, 32], # width of targeted loading in kb,
    'cohesins_per_mm':[32, 64] # if none, that means no bias
}
