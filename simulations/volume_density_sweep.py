...
def test_sweep(test_idx, region_size, CTCF_L, CTCF_R, sticky_elts, birthArray):
    ...
    # slice out the specific region from the full chromosome arrays
...
save_base_folder = f"/mnt/md1/varshini/Blood/sim_data_density/{datetime.today()}"
...
if __name__ == '__main__':
    ...
    for config in generate_param_grid(simulation_sweep_space):
        ...
        volume_density = config['volume_density']
        density = config['volume_density']
